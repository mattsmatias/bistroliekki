...
ICONS = {
    ...
    "youtube": '<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">'
               ...
               '</svg>',
    "snapchat": '<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">'
                '<path d="M12 2.2c-3 0-5 2.2-5 5.1 0 .6.1 1.4.1 1.9-.5.3-1 .1-1.4-.2-.5-.4-1.2 0-1.2.6 0 .8.7 1.4 1.5 1.7.3.2.6.3.6.6 0 .6-1.6 2.2-3.3 2.6-.4.1-.6.5-.5.9.2.6 1.1.9 1.9 1 .1.4.2.7.4.9.2.2.6.2 1 .1.5 0 1-.1 1.6.1.6.2 1.1.6 1.7 1 .6.4 1.3.7 2.4.7s1.8-.3 2.4-.7c.6-.4 1.1-.8 1.7-1 .6-.2 1.1-.1 1.6-.1.4.1.8.1 1-.1.2-.2.3-.5.4-.9.8-.1 1.7-.4 1.9-1 .1-.4-.1-.8-.5-.9-1.7-.4-3.3-2-3.3-2.6 0-.3.3-.4.6-.6.8-.3 1.5-.9 1.5-1.7 0-.6-.7-1-1.2-.6-.4.3-.9.5-1.4.2 0-.5.1-1.3.1-1.9 0-2.9-2-5.1-5-5.1z"/>'
                '</svg>',
...
def build_footer(depth):
  ...
  <div class="kuori footeri__ruudukko">
    <div>
      ...
      <!-- Restaurant Gurun tunnustusmerkki. Merkin oma ulkoasu tulee
           tyylitiedostosta awards.infcdn.net, joka ladataan vasta kun
           alatunniste lähestyy ruutua (site.js: tunnusmerkki). Merkin
           alkuperäisessä koodissa oli inline-onclick; se on korvattu
           site.js:n tapahtumankäsittelijällä, joka avaa linkin
           noopener-lipulla. Muuten merkki on sellaisenaan. -->
      <div class="tunnusmerkki" data-tunnusmerkki>
        <div id="circle-r-ribbon" class=" rg-award-lang-en_US" style="cursor: pointer; overflow: hidden; position: relative; display: flex; flex-direction: column; padding: 0; max-width: 174px; min-width: 174px; height: 135px; font: 400 10px/normal 'Akrobat Bold', 'Helvetica Neue', 'Arial', sans-serif; align-items: center; text-align: center; color: #000 !important; text-shadow: none; background: url(https://awards.infcdn.net/img/bg.svg) no-repeat; box-sizing: border-box;"> <div class="r-ribbon_ahead " style="transform: rotate(-11deg); position: absolute; z-index: 4; top: -7px; left: 6px; letter-spacing: 0.2px; padding: 0;"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="160px" height="160px" viewBox="0 0 160 160" style="width: 160px; height: 160px; margin-top: 0;"> <defs> <path id="heading-arc" d="M 30 80 a 50 50 0 1 1 100 0"></path> </defs> <text class="r-ribbon_ahead-heading" fill="#000" text-anchor="middle" style="font-size: 9px !important; font-family: 'Akrobat Bold', 'Helvetica Neue', 'Arial', sans-serif !important; line-height: 1; text-transform: uppercase !important; alignment-baseline: auto;"> <textPath startOffset="50%" xlink:href="#heading-arc">Best food delivery</textPath> </text> </svg> </div> <p class="r-ribbon_year" style="color: #000; width: 140px; font: 22px/normal 'Akrobat Black', 'Helvetica Neue', 'Arial', sans-serif !important; font-style: italic !important; transform: rotate(-12deg); position: absolute; top: 41px !important; left: 12px !important; letter-spacing: 0.6px; text-align: center !important; padding: 0 !important; margin: 0 !important;">2026</p> <a href="https://restaurantguru.com/Bistro-Liekki-Vantaa" class="r-ribbon_title" target="_blank" rel="noopener" style="text-transform: uppercase; color: #fff !important; width: 140px; font-size: 10px !important; line-height: normal !important; font-family: 'Akrobat Bold', 'Helvetica Neue', 'Arial', sans-serif !important; font-style: italic !important; transform: rotate(-12deg); position: absolute; z-index: 5; top: 70px; left: 16px; letter-spacing: 0.4px !important; text-align: center !important; white-space: normal; padding: 0 !important; margin: 0 !important; text-decoration: none !important; border-bottom: none; box-shadow: none; height: 22px; display: flex; align-items: center; justify-content: center;">Bistro Liekki Talvikkitie</a> <div class="r-ribbon_ahead r-ribbon_ahead-bottom" style="top: auto; bottom: -14px; left: 26px; letter-spacing: 0.3px; transform: rotate(-13deg); height: 100% !important; max-width: 100%; padding: 0; position: absolute !important; z-index: 4;"> <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="120px" height="120px" viewBox="0 0 120 120" style="width: 120px; height: 120px; margin-top: 0;"> <defs> <path id="subheading-arc" d="M 12 60 a 48 48 0 0 0 96 0"></path> </defs> <text class="r-ribbon_ahead-subh" fill="#000" text-anchor="middle" style="font: 12px/1 'Akrobat Regular', 'Helvetica Neue', 'Arial', sans-serif !important; text-transform: uppercase; letter-spacing: normal;"> <textPath startOffset="50%" xlink:href="#subheading-arc"><a href="https://restaurantguru.com" target="_blank" rel="noopener" style="font: 12px/1 'Akrobat Regular', 'Helvetica Neue', 'Arial', sans-serif !important; text-transform: uppercase; letter-spacing: 0.3px; text-decoration: none !important; border-bottom: none; box-shadow: none; padding: 0; margin: 0;">Restaurant Guru</a></textPath> </text> </svg> </div></div>
      </div>
    </div>
